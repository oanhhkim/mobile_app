    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                String maLop = dschuyenn.get(position).toString();
                ...
                for (int i = 0; i < svlist.size(); i++) {
                    ...
                    if (maLop.matches(sv.getMaChuyenNganh())) {
                ...
                if (dem > 0) {
                    ...
                    Toast.makeText(DanhSachChuyenNganh.this, "Không có sinh viên nào thuộc mã ngành " + dschuyenn.get(position), Toast.LENGTH_LONG).show();
                }
            }
        });
